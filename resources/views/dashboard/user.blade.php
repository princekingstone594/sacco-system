...
<div class="space-y-6" x-data="{ showMoney: false }">

    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            <div class="h-16 w-16 shrink-0 overflow-hidden rounded-lg border border-[#ded8c8] bg-white shadow-sm">
                ...
                @else
                    <div class="flex h-full w-full items-center justify-center bg-[#f6f1e6] text-2xl font-extrabold text-[#4b2673]">
        ...
        <div class="rounded-lg border border-[#ded8c8] bg-white p-4 text-left shadow-sm sm:min-w-72 sm:text-right">
            <div class="flex items-center justify-between gap-4 sm:justify-end">
                ...
                <button type="button"
                    ...
                    class="inline-flex h-9 w-9 items-center justify-center rounded-md border border-[#ded8c8] text-[#4b2673] hover:bg-[#f6f1e6]">
